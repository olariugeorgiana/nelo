        ...
        $("input[name='userAccount.email']").autocomplete({
                ...
                $.getJSON("${pageContext.request.contextPath}/admin/searchUser", {
                    ...
                    response($.map(result, function (item) {
                        return {
                            ...
                            identityCardEndDate: item.identityCardEndDate,
            ...
            select: function (event, ui) {
                if (ui.item) {
                    ...
                    $("input[name='userAccount.identityCardNo']").val(ui.item.identityCardNo);
                    $("input[name='userAccount.identityCardEndDate']").val(ui.item.identityCardEndDate);
                    $("input[name='userAccount.nationality']").val(ui.item.nationality);
                    $("input[name='userAccount.address']").val(ui.item.address);
                }
            },
            minLength: 2
        });
...
<form:form commandName="registrationSearch" action="${pageContext.request.contextPath}/admin/registration" method="POST"
...
<fieldset style="width:350px;display: inline-block;vertical-align: top;">
    ...
    <div class="fields floatLeftLabels">
        ...
        <div>
            <form:label path="userAccount.identityCardNo">ID Number:</form:label>
            <form:input path="userAccount.identityCardNo"></form:input>
        </div>

        <div>
            <form:label path="userAccount.identityCardEndDate">ID Expiration Date:</form:label>
            <form:input path="userAccount.identityCardEndDate"></form:input>
        </div>

        <div>
            <form:label path="userAccount.nationality">Nationality:</form:label>
            <form:input path="userAccount.nationality"></form:input>
        </div>

        <div>
            <form:label path="userAccount.address">Address:</form:label>
            <form:input path="userAccount.address"></form:input>
        </div>
...
<fieldset>
    ...
    <div class="fields">
        ...
        <form:label id="totalPriceId" path="totalPaid">${registrationSearch.totalPaid} &#8364;</form:label>
